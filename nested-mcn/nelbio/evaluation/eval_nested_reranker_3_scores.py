...
from nelbio.utils.nested_utils_sep_context import evaluate_nested_flat_with_sep_context
...
def main(args):
    ...
    model = NestedScoreRerankNet(bert_encoder,
                                 ...
                                 flat_dense_weight=1.,
                                 sep_dense_weight=1.,
                                 sep_pooling=sep_pooling).to(device)
    model.load_model(args.model_name_or_path)

    result_evalset = evaluate_nested_flat_with_sep_context(
