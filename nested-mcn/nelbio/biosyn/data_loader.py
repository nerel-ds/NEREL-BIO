...
class CandidateDataset(Dataset):
    ...
    def __getitem__(self, query_idx):
        ...
        query_token = self.tokenizer(query_name, max_length=self.max_length, padding='max_length',
        ...
        candidate_tokens = self.tokenizer(candidate_names, max_length=self.max_length,  return_token_type_ids=True,
